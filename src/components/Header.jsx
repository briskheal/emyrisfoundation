      ...
      <div className="container header-container">
        ...
        <nav className={`nav-menu ${mobileMenuOpen ? 'open' : ''}`} id="nav-links">
          ...
          <div className={`nav-dropdown ${activeDropdown === 'work' ? 'active' : ''}`}>
            ...
            <div className="dropdown-menu">
              <Link href="/work/education" onClick={() => setMobileMenuOpen(false)}>Education</Link>
              <Link href="/work/health" onClick={() => setMobileMenuOpen(false)}>Health</Link>
              <Link href="/work/livelihood" onClick={() => setMobileMenuOpen(false)}>Livelihood</Link>
              <Link href="/work/women-empowerment" onClick={() => setMobileMenuOpen(false)}>Women Empowerment</Link>
              <Link href="/work/farmers-connect" onClick={() => setMobileMenuOpen(false)}>Farmer's Connect</Link>
          ...
          <div className={`nav-dropdown ${activeDropdown === 'campaigns' ? 'active' : ''}`}>
            ...
            <div className="dropdown-menu">
              <Link href="/campaigns/shiksha-hi-surakhya" onClick={() => setMobileMenuOpen(false)}>Shiksha Hi Surakhya</Link>
              <Link href="/campaigns/blood-donation" onClick={() => setMobileMenuOpen(false)}>Blood Donation</Link>
              <Link href="/campaigns/organ-donation" onClick={() => setMobileMenuOpen(false)}>Organ Donation</Link>
              <Link href="/campaigns/plantation-awareness" onClick={() => setMobileMenuOpen(false)}>Plantation Awareness</Link>
              <Link href="/campaigns/social-welfare" onClick={() => setMobileMenuOpen(false)}>Social Welfare</Link>
            </div>
          </div>
