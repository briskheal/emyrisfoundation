      ...
      {editing && (
        <form onSubmit={handleSave} style={{ background: 'rgba(0,0,0,0.2)', padding: '20px', borderRadius: '8px', marginBottom: '20px' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', color: 'rgba(255,255,255,0.7)', fontSize: '0.8rem', marginBottom: '5px' }}>Grid Card Thumbnail (Single Image only. Go to 'Campaign Content' for Banners & Gallery)</label>
