...
const PartnershipDetailEditor = ({ partnership, token, onBack }) => {
  const [formData, setFormData] = useState({
    title: partnership?.title || '',
    titleSize: partnership?.titleSize || '3.5rem',
    bannerImg: partnership?.bannerImg || '',
  ...
  return (
    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', borderRadius: '12px' }}>
      ...
      <h2 style={{ color: 'var(--primary-orange)', marginBottom: '20px' }}>Editing partnership: {formData.title}</h2>
      ...
      <div style={{ display: 'grid', gap: '20px', marginTop: '20px' }}>
        ...
        <div>
          <label style={{ display: 'block', fontWeight: '600', marginBottom: '8px', color: 'var(--primary-orange)' }}>Font Awesome Icon Class</label>
          <input 
            type="text" 
            value={formData.icon} 
        ...
        <div>
          <label style={{ display: 'block', fontWeight: '600', marginBottom: '8px', color: 'var(--primary-orange)' }}>Short Summary (For Card)</label>
          <textarea 
            value={formData.summary} 
            onChange={(e) => setFormData({...formData, summary: e.target.value})}
            style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.2)', background: '#222', color: 'white', minHeight: '80px' }}
          />
        </div>
        ...
        <div style={{ marginBottom: '20px' }}>
          <label style={{ display: 'block', marginBottom: '8px', color: 'var(--primary-orange)', fontWeight: 600 }}>
            partnership Content (Rich Text Editor)
          </label>
          <WysiwygEditor 
...
export default PartnershipDetailEditor;
