...
const MentorManager = ({ token }) => {
  ...
  if (loading) return <div style={{ color: 'white' }}>Loading Mentors...</div>;

  return (
    <div>
      <h3 style={{ color: 'white', marginBottom: '20px' }}><i className="fa-solid fa-chalkboard-user" style={{ color: '#f97316' }}></i> Manage Mentors & Advisors</h3>
      ...
      <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px dashed rgba(255,255,255,0.2)', borderRadius: '12px', padding: '24px' }}>
        <h4 style={{ color: 'white', marginTop: 0 }}>{editing ? 'Edit Mentor' : 'Add New Mentor'}</h4>
